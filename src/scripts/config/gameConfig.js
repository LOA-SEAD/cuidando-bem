...
*/
    ...
    level1.registerInteractiveObject(new InteractiveObject("Objeto teste", "objeto_teste",
                            function(){
                                console.log("First interactive object working");
                            }), 0);
    level1.registerInteractiveObject(new InteractiveObject("Objeto teste", "objeto_teste2",
                            function(){
                                console.log("Second interactive object working");
                            }), 1);
