...
!function (a, b) {
    ...
    function d(a, b) {
        "undefined" != typeof L && w.logLevel >= b && L.log("less: " + a)
    }
    ...
    function j(a, b) {
        w.errorReporting && "html" !== w.errorReporting ? "L" === w.errorReporting ? f(a, b) : "function" == typeof w.errorReporting && w.errorReporting("add", a, b) : i(a, b)
    }
    ...
    function m(a) {
        w.errorReporting && "html" !== w.errorReporting ? "L" === w.errorReporting ? l(a) : "function" == typeof w.errorReporting && w.errorReporting("remove", a) : k(a)
    }
