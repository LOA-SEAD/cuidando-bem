...
define(['../../modules/levelsData', 'Scene', 'Action', 'Level', 'Dialog', 'InteractiveObject', 'Flag', 'CuidandoBem'],
    function (game, Scene, Action, Level, Dialog, InteractiveObject, Flag, core) {
        ...
        var dialog_recep = [[]];
        // Recepcionista
        dialog_recep[0][0] = "Essa é uma fase teste, para verificar features da engine";
        // Jogador
        ...
        recepcao.registerAction(
            new Action("btn-wuuuut","Ir ao blorbs",
                "action-ir_corredor", function(){
                    core.registerScoreItem("Testando esse esquema", 3000);
                    core.showEndOfLevel();
                }, true));
