...
/*            // Dialog 1 - Vá para o posto de enfermagem
        ...
        leito.registerDialogs([
            ...
            new Dialog( lib.characters.jogador )
                .setText("")
                .registerOption( Dialogs.leitoPaciente[ 0 ], function() {
                    core.openDialog( 4 );
                }),
            // Dialog 4
            new Dialog( lib.characters.pacientes.pedro )
            ...
            new Dialog( lib.characters.jogador )
                .setText("")
                .registerOption( Dialogs.leitoPaciente[ 6 ], function() {
                    core.openDialog( 8 );
                }),
            // Dialog 8
            new Dialog( lib.characters.mentor )
...
*/
                ...
                .onClick(function() {
                    if ( level.getFlag("score_pegou_soro").getValue() == true &&
                        ...
                        level.getFlag("pegarBandeja").getValue() == true*/ ) {
                            level.getFlag("pegou_instrumentos").setValue( true );
        ...
        postoDeEnfermagem.registerDialogs([
            ...
            new Dialog( lib.characters.jogador )
                .setText("")
                .registerOption( Dialogs.postoDeEnfermagem[ 4 ], function() {
                    core.openDialog( 1 );
                }),
            // Dialog 3
            new Dialog( lib.characters.mentor )
