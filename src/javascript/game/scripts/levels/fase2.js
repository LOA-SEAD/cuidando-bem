  ...
  function( game, Scene, Action, Level, Dialog, InteractiveObject, Flag, core, lib, Pulseira, Prontuario, FreqRespiratoria, Scores ) {
    ...
    corredor = lib.scenes.corredor.getClone()
      .onLoad(function() {
        ...
        if ( !core.flag("conversar_mentor") ) {
          ...
          core.openDialog( 0 );
        } else if ( core.flag("examinar_paciente") && !core.flag("conversar_mentor2") ) {
          core.openDialog( 2 );
        }
      })
      .onUnload(function() {
    ...
    corredor.registerDialogs([
      ...
      new Dialog( lib.characters.jogador )
        ...
        .registerOption( Dialogs.corredor.fala2[ 7 ], function() {
          ...
          if ( !core.flag("score_falar_com_mentor") ) {
      ...
      new InteractiveObject("io-conversar_mentor", "Conversar com Mentor")
        ...
        .onClick(function() {
          ...
          if ( !core.flag("examinar_paciente") ) {
            core.flag("conversar_mentor", true );
            core.openDialog( 0 );
          } else if ( core.flag("examinar_paciente") ) {
            core.openDialog( 2 );
          }
        })
        .setVisibility( true )
    ...
    salaDeLeitos.registerInteractiveObjects([
      ...
      new InteractiveObject("io-ir_corredor", "Ir ao Corredor")
        ...
        .onClick(function() {
          if ( !core.flag("foi_ao_leito") ) {
            core.changeScene( 1 );
          } else {
            if ( core.flag("lavar_maos2") ) {
              core.changeScene( 1 );
            } else {
              core.openDialog( 1 );
            }
    ...
    salaDeLeitos.registerActions([
      ...
      new Action("btn-ler_prontuario", "Anotar no prontuario")
        ...
        .onClick(function() {
          ...
          if ( !core.flag("lavar_maos3") ) {
            core.openDialog( 2 );
          } else {
            if ( !core.flag("score_ler_prontuario") ) {
              core.flag("score_ler_prontuario", true );
              core.registerScoreItem( Scores.lerProntuario );
            }
            console.log("Action: ler prontuario");
            Prontuario.open("prescEnfermagem");
    ...
    leito.registerInteractiveObjects([
      ...
      new InteractiveObject("io-pulseira_paciente", "Checar pulseira do paciente")
        ...
        if(core.flag("lavarMaosAntesInspecao")){ 
    ...
    leito.registerActions([
      new Action("btn-examinar_paciente", "Inspecionar Pele")
        ...
        .onClick(function() {
          ...
          Player.play( Player.audios.sfx.lavarMaos );
            ...
            if(core.flag("lavarMaosAntesInspecao") == false){
                core.flag("lavarMaosAntesInspecao", true);
            }     
            
            if(core.flag("score_lavarMaosAntesInspecao") == false){
                core.flag("score_lavarMaosAntesInspecao", true);
      ...
      new Action("btn-mudar_posicao", "Mudar posição do paciente")
        ...
        .onClick(function() {
          ...
          if ( !core.flag("score_mudar_posicao") ) {
            core.flag("score_mudar_posicao", true );
            core.registerScoreItem( Scores.mudarPosicaoCoxim );
          }
        })
        .setVisibility( false ),
    ...
    postoDeEnfermagem.registerActions([
        ...
        .onClick(function() {
          ...
          Player.play( Player.audios.sfx.lavarMaos );
            ...
            if(core.flag("score_lavarMaosAntesBandeja") == false){
                core.flag("score_lavarMaosAntesBandeja", true);
    ...
    postoDeEnfermagem.registerInteractiveObjects([
      ...
      new InteractiveObject("io-pegar_bandeja", "Pegar bandeja")
        ...
        if(core.flag("lavarMaosAntesBandeja")) {  
    ...
    zoom.registerActions([
      new Action("btn-fechar_zoom", "Finalizar Inspeção")
        ...
        .onClick(function() {
          ...
          if ( !core.flag("score_examinar_paciente") ) {
    ...
    pulseira.registerActions([
      new Action("btn-largar_pulseira", "Fechar pulseira")
        ...
        .onClick(function() {
          ...
          if ( !core.flag("confirmou_pulseira") && core.flag("conversarPaciente") ) {
    ...
    gaveta.registerInteractiveObjects([
      new InteractiveObject("io-coxim", "Coxim")
        ...
        .onClick(function() {
          ...
          if ( !core.flag("score_pegar_coxim") ) {
    ...
    level.registerFlag( new Flag("score_mudar_posicao", false ) );
    level.registerFlag( new Flag("lavarMaosAntesInspecao", false ) );
