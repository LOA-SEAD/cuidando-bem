define(function ()
{
    ...
    return {
        ...
        level5: {
            ...
            naoFalarComPaciente: new Score("Não conversar com paciente", -150),
            verificarPulseira: new Score("Verificar a pulseira", 100),
            naoVerificarPulseira: new Score("Não verificar a pulseira", -100),
            //falarComPaciente2: new Score("Conversar com paciente", 150),
            fazerTesteGlicemia: new Score("Fazer teste de glicemia capilar", 100),
            naoFazerTesteGlicemia: new Score("Não fazer teste de glicemia capilar", -100),
            jogarAgulhaLixoCerto: new Score("Jogar agulha no descarpax", 50),
            naoJogarAgulhaLixoCerto: new Score("Não jogar agulha no descarpax", -50),
            jogarAlgodaoBandeja: new Score("Jogar agulha na bandeja", 50),
            naoJogarAlgodaoBandeja: new Score("Não jogar agulha na bandeja", -50),
            selecionarMateriaisCurativo: new Score("Selecionar todos os materiais do curativo", 350),
            naoSelecionarMateriaisCurativo: new Score("Não selecionar todos os materiais do curativo", -350),
            lavarMaosAntesLuva: new Score("Lavar as mãos antes de calçar a luva estéril", 200),
            naoLavarMaosAntesLuva: new Score("Não lavar as mãos antes de calçar a luva estéril", -200),
            calcarLuvaProcedimento: new Score("Calçar a luva de procedimento", -150),
            calcarLuvaEsteril: new Score("Calçar a luva estéril", 150),
            naoCalcarLuvaEsteril: new Score("Não calçar a luva estéril", -150),
            fazerCurativo: new Score("Fazer o curativo na paciente", 150),
            naoFazerCurativo: new Score("Não fazer o curativo na paciente", -150),
            identificarCurativo: new Score("Identificar o curativo feito", 150),
            naoIdentificarCurativo: new Score("Não identificar o curativo feito", -150),
            elevarGradeDaCama: new Score("Elevar a grade da cama", 350),
            naoElevarGradeDaCama: new Score("Não elevar a grade da cama", -350),
